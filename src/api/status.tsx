export const statusCodeGroups = [
  // 1xx: Informational responses
  {
    ...
    handling:
      "Informational responses, often used for intermediate steps. No error handling needed.",
  },
  ...
  // 2xx: Successful responses
  {
    ...
    handling:
      "Successful responses, no error handling required. The request was successful.",
  },
  ...
  // 3xx: Redirection responses
  {
    ...
    handling:
      "Redirection responses indicate that further action is needed to fulfill the request. Typically, no error handling needed but the client should follow the redirection.",
  },
  ...
  // 4xx: Client error responses
  {
    ...
    handling:
      "Client errors indicate issues with the request, which typically require the client to fix (e.g., incorrect data, unauthorized access).",
  },
  ...
  // 5xx: Server error responses
  {
    ...
    handling:
      "Server errors indicate issues on the server side. These need to be handled by the server, and the client should be informed that the server is unavailable or encountering issues.",
  },
];
