...
const Discovering = () => {
    return (
       ...
       <div className="flex  flex-col tems-center xl:mt-10  ">
        ...
        <h1 className="2xl:text-6xl/normal xl:text-5xl/normal font-extrabold xl:text-left text-center md:text-3xl/normal text-2xl/normal lg:text-4xl/normal "> That one <span className="text-primary">opportunity</span> feeling.<br/>
        <span className="text-primary">Opportunity</span>  Done.</h1>
        <p className="mt-10 md:text-2xl/relaxed xl:text-left text-center sm:text-96/normal text-80 max-w-[80%]">Discover internships that match your passion, skills, and future goals. Your next big opportunity is just a click away.</p>
        </section>
